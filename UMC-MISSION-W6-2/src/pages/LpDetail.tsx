...
const LpDetail = () => {
  ...
  useEffect(() => {
    if (lp && userId !== null) {
      ...
      const likedByMe = lp.likes.some((like) => like.userId === Number(userId)); //localstorage에서 꺼내면 string이므로 타입변경
