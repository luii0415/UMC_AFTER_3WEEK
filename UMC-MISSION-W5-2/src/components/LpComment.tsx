  ...
  return (
    <div className="p-4 flex flex-col gap-4">
          ...
          <button
            className={`px-3 py-1 font-medium transition ${
              order === "asc"
                ...
                : "bg-black text-white border-l border-black"
            }`}
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <button className="px-3 py-2 text-sm bg-gray-500 text-white rounded">
          작성
        </button>
      </div>
      ...
      <div className="flex flex-col gap-2">
        {data?.pages.map((page) =>
          page.data.map((comment: Comment) => (
            <div
              key={comment.id}
              className="flex items-start gap-3 py-3 px-2 border-b border-gray-700"
            >
